...
GoogleGeocoder.prototype._formatResult = function (result) {
    ...
    for (var x = 0; x < result.address_components[i].types.length; x++) {
      ...
      switch (addressType) {
        ...
        case 'postal_town':
          ...
          // https://github.com/DenisCarriere/geocoder/blob/master/geocoder/google.py#L97-L103
        ...
        // 'policital' can be really high-level like Greater London so wouldn't want that for neighborhood
        // case 'political':
        case 'sublocality':
        case 'neighborhood':
  ...
  // Back-filling missing fields -- doesn't fit the logic above
  // If you don't know neighborhood but you do know administrative level 4,
  // that makes a good approximation of neighborhood so use that instead
  // extractedObj.extra.neighborhood = extractedObj.extra.neighborhood || extractedObj.administrativeLevels.level4short;
